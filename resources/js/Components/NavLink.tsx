...
export default function NavLink({ active = false, className = '', children, ...props }: InertiaLinkProps & { active: boolean }) {
    ...
    const inactiveClassName = 'text-white hover:text-purple-600 hover:bg-white hover:border-b-2 hover:border-purple-600 focus:text-purple-600 focus:bg-white focus:border-b-2 focus:border-purple-600';
